...
При настройке горизонтального шардинга предлагаю анализировать данные наиболее загруженной таблицы. Предположим, что это таблица User. Сортировку будем проводить по userID, данные двух дркгих таблиц будут подтягиваться по ключам. При наличии ресурсов выделим под шардинг 3 сервера, при ограниченности ресурсов - 2. В случае с 2-мя серверами на первом сервере разместим первые 50% userID, на втором - оставшиеся 50%.
